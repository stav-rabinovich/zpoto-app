...
exports.sendOnboardingSignatureEmail = sendOnboardingSignatureEmail;
exports.sendSignatureConfirmationEmail = sendSignatureConfirmationEmail;
 ...
 */
async function sendOnboardingSignatureEmail(to, onboardingData, requestId) {
 ...
 */
async function sendSignatureConfirmationEmail(to, name) {
    const transporter = createTransporter();
    const htmlContent = `
<!DOCTYPE html>
<html dir="rtl" lang="he">
